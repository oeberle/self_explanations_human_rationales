...
for task in ['sst', 'sst_multilingual', 'forced_labour']:
    ...
    for lidx, lang in enumerate(loops):
        ...
        plot_dir = 'model_responses/plots/contrast/{}'.format(task)
        ...
        for strategy in strategies:
          ...
          #  ax_contrast.set_xticklabels(df_plausibility_contrastive.columns, rotation=90, ha='center')
    
            contr_xticks = df_plausibility_contrastive.columns
            contr_xticks = [s.replace('_contrast', ' (contr.)') for s in contr_xticks]
            ax_contrast.set_xticklabels(contr_xticks, rotation=90, ha='center')
